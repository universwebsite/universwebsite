...
- [`mediahard-app/wiki/ops`](https://github.com/universwebsite/mediahard-app/tree/main/wiki/ops) — инфраструктурные статьи, чек‑листы, сценарии восстановления.
- [`mkdocs.yml`](https://github.com/universwebsite/mediahard-app/blob/main/wiki/ops/mkdocs.yml) — навигация и структура документации.
